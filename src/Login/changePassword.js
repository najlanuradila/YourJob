                ...
                <div className="flex mt-4 space-x-3 md:mt-6">
                    <form onSubmit={handleSubmitPass}>
                        ...
                        <div className="mb-6">
                            ...
                            <button className=" text-white bg-[#6A5ACD] hover-bg-blue-800focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Submit
                            </button>
