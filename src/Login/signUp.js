...
const SignUp = () => {
    ...
    return(
        <>
            <div className=" mb-20 mt-10 m-auto my-14 relative overflow-x-auto w-full max-w-xl max-h-full p-4 bg-white border border-gray-200 rounded-2xl shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                <form onSubmit={handleSubmitRegister} className="space-y-6" action="#">
                    <div className="flex item-center justify-center">
                        <span className="self-center text-xl font-bold whitespace-nowrap dark:text-white">Create Account</span>
                    </div>
                    ...
                    <button type="submit" className="w-full text-white bg-[#371732]/95 hover:bg-[#371732] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  dark:focus:ring-blue-800">
                        Submit
                    </button>
                    <div className="mt-5 text-sm font-medium text-gray-500 ">
                    Already have an account? 
                <Link to="/login" className="font-bold text-[#371732] hover:underline"> Login Here!</Link>
            </div>
                </form>
            </div>       
        </>
